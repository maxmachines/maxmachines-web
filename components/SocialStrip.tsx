...
const socials = [
  {
    name: "WhatsApp",
    href: "https://whatsapp.com/channel/0029Vb6Sttp1yT2HqDtufu2f",
    icon: (
  ...
  {
    name: "YouTube",
    href: "http://www.youtube.com/MaxMachineToolsModi",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5" aria-hidden="true">
  ...
  {
    name: "Instagram",
    href: "https://www.instagram.com/MaxMachineToolsModi/",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5" aria-hidden="true">
  ...
  {
    name: "Facebook",
    href: "http://www.facebook.com/MaxMachineToolsModi",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5" aria-hidden="true">
  ...
  {
    name: "LinkedIn",
    href: "https://linkedin.com/company/MaxMachineTools",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5" aria-hidden="true">
